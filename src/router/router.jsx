...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({params}) => fetch(`https://assignment-11-server-r4tang1gd-isalim079.vercel.app/category/${params.id}`)
            },
            {
                path: "/allBooks",
                element: (
            ...
            },
            {
                ...
                loader: () => fetch("https://assignment-11-server-r4tang1gd-isalim079.vercel.app/category"),
            },
            {
                path: "/borrowedBooks",
                element: (
                ...
                loader: () => fetch("https://assignment-11-server-r4tang1gd-isalim079.vercel.app/borrowedBooks"),
            },
            {
