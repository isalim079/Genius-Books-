...
const BorrowedBooks = () => {
    ...
    useEffect(() => {
        fetch("https://assignment-11-server-jq8r1lvgd-isalim079.vercel.app/category")
            .then((res) => res.json())
            .then((data) => {
    ...
    const handleReturn = (id) => {
        ...
        Swal.fire({
            ...
            if (res.isConfirmed) {
                fetch(`https://assignment-11-server-jq8r1lvgd-isalim079.vercel.app/borrowedBooks/${id}`, {
                    method: "DELETE",
                })
                    .then((res) => res.json())
                    .then((data) => {
