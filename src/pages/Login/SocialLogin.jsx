...
const SocialLogin = () => {
    ...
    useEffect(() => {
        axios
            .get("https://assignment-11-server-r4tang1gd-isalim079.vercel.app/geniusBooksUsers")
            .then((res) => {
        ...
        media()
            .then((res) => {
                if (res?.user) {
                    ...
                    if (!userExists) {
                        fetch("https://assignment-11-server-r4tang1gd-isalim079.vercel.app/geniusBooksUsers", {
                            method: "POST",
                            headers: {
